...
export default async function DashboardPage() {
  ...
  for (const client of clients) {
    ...
    if (existing) {
      ...
      grouped.push({ day, label: dayLabel(client.created_at, todayStr, yesterdayStr), clients: [client] });
    }
  }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 px-4 py-6 max-w-2xl mx-auto w-full">
        ...
        <Link
          href="/client/new"
          className="flex items-center justify-center gap-2 w-full rounded-2xl bg-blue-600 px-4 py-4 text-base font-semibold text-white hover:bg-blue-700 transition-colors mb-6 shadow-sm"
        >
        ...
        {clients.length === 0 ? (
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="text-sm">Apasă „Client nou" pentru a începe.</p>
          </div>
        ) : (
